...
final class TC_INSTALLER_Plugin{
	...
	public function __construct() {
		...
		-----------------------------------------*/
		register_activation_hook( TC_INSTALLER_PLUGIN_FILE, array( $this, 'onActivation' ) );
		register_deactivation_hook( TC_INSTALLER_PLUGIN_FILE, array( $this, 'onDeactivation' ) );
