<?php
class TC_INSTALLER_Plugin_Autoloader{
	...
	*/
	public function autoloadEngine( $class ){
		$prefix   = tc_installer_config( 'namespace' ) .'\\';
		$base_dir = TC_INSTALLER_PATH .'engine/';
	...
	*/
	public function autoloadComponents( $class ){
		$prefix   = tc_installer_config( 'namespace' ) .'\\Component\\';
		$base_dir = TC_INSTALLER_PATH .'components/';
...
new TC_INSTALLER_Plugin_Autoloader;